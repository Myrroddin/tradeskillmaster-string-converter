...
local function ToggleFrame()
    ...
    local help_button = gui:Create("Button")
    help_button:SetText(HELP_LABEL)
    help_button:SetRelativeWidth(0.15)
    help_button:SetCallback("OnClick", function()
        PrintCommands()
    end)
    main_frame:AddChild(help_button)
